                ...
                script {
                    ...
                    for (def service in microservices) {
                        ...
                        dir(service) {
                            ...
                            sh 'docker run trufflesecurity/trufflehog  --json https://github.com/youssefrmili/Ecommerce-APP.git > trufflehog'
                            sh 'cat trufflehog'
                        }
                    }
                }
            ...
            steps {
                script {
                    ...
                    for (def service in microservices) {
                        ...
                        sh "trivy image youssefrm/${service}:latest > trivy.txt"
                    }
                }
            }
        }
